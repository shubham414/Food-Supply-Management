...
public class GovernmentManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    /**
     * Creates new form GovernmentManageOrganizationJPanel
     */
    ...
    private void populateCombo() {
        ...
        jcbOrganization.addItem(Organization.Type.Government);
        jcbOrganization.addItem(Organization.Type.GovtAnalyst);
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 290, 440, 150));

        jLabel6.setFont(new java.awt.Font("Microsoft JhengHei", 1, 24)); // NOI18N
        jLabel6.setText("Activity:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 200, 110, -1));

        lblCustomername1.setFont(new java.awt.Font("Microsoft JhengHei", 0, 24)); // NOI18N
        lblCustomername1.setText("Organization");
        add(lblCustomername1, new org.netbeans.lib.awtextra.AbsoluteConstraints(990, 200, 170, -1));

        jLabel7.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel7.setText("Organization Type:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 490, 140, -1));
        ...
        add(jcbOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 490, 259, 29));
        ...
        add(btnCreateOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(890, 580, 204, 40));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(790, 580, 49, 39));
