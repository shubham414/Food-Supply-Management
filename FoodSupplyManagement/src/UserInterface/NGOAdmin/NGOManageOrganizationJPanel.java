...
public class NGOManageOrganizationJPanel extends javax.swing.JPanel {
    ...
    public NGOManageOrganizationJPanel(JPanel userProcessContainer, OrganizationDirectory directory) {
        initComponents();
    ...
    private void populateCombo() {
        ...
        jcbOrganization.addItem(Organization.Type.NGO);
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 280, 470, 150));

        jLabel6.setFont(new java.awt.Font("Microsoft JhengHei", 1, 24)); // NOI18N
        jLabel6.setText("Activity:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(910, 190, -1, -1));

        lblCustomername1.setFont(new java.awt.Font("Microsoft JhengHei", 0, 24)); // NOI18N
        lblCustomername1.setText("Organization");
        add(lblCustomername1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1010, 190, 200, -1));

        jLabel7.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel7.setText("Organization Type:");
        add(jLabel7, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 490, 140, -1));
        ...
        add(jcbOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 490, 259, 29));
        ...
        add(btnCreateOrganization, new org.netbeans.lib.awtextra.AbsoluteConstraints(950, 550, 204, 40));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 550, -1, 39));
