 ...
 * @author
 */
public class SupplierlManageUserAccountJPanel extends javax.swing.JPanel {

    private JPanel container;
    private Enterprise enterprise;
    private EcoSystem system;

    public SupplierlManageUserAccountJPanel(JPanel container, Enterprise enterprise, EcoSystem system) {
        initComponents();
    ...
    private void initComponents() {
        ...
        add(jcbRole, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 460, 208, 29));

        jLabel6.setFont(new java.awt.Font("Microsoft JhengHei", 1, 24)); // NOI18N
        jLabel6.setText("Activity:");
        add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 130, 110, -1));

        jLabel11.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel11.setText("Role");
        add(jLabel11, new org.netbeans.lib.awtextra.AbsoluteConstraints(860, 460, 50, -1));

        lblCustomername1.setFont(new java.awt.Font("Microsoft JhengHei", 0, 24)); // NOI18N
        lblCustomername1.setText("User Account");
        add(lblCustomername1, new org.netbeans.lib.awtextra.AbsoluteConstraints(1000, 130, 160, -1));

        txtPassword.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        txtPassword.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        add(txtPassword, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 540, 207, 27));
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(750, 210, 480, 150));

        jLabel12.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel12.setText("Password");
        add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 540, 80, -1));

        btnCreateUserAccount.setBackground(new java.awt.Color(102, 102, 102));
        btnCreateUserAccount.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        btnCreateUserAccount.setForeground(new java.awt.Color(255, 255, 255));
        btnCreateUserAccount.setText("Create User Account");
        btnCreateUserAccount.setMaximumSize(new java.awt.Dimension(200, 200));
        btnCreateUserAccount.setMinimumSize(new java.awt.Dimension(200, 200));
        ...
        add(btnCreateUserAccount, new org.netbeans.lib.awtextra.AbsoluteConstraints(920, 600, 223, 39));
        ...
        add(jcbOrg, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 380, 208, 29));
        ...
        add(btnBack, new org.netbeans.lib.awtextra.AbsoluteConstraints(800, 600, -1, 39));

        jLabel8.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel8.setText("Organization");
        add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(810, 380, 90, -1));
        ...
        add(txtUserName, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 500, 207, 27));

        jLabel9.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel9.setText("UserName");
        add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(820, 500, 80, -1));
        ...
        add(jcbOrgEmp, new org.netbeans.lib.awtextra.AbsoluteConstraints(930, 420, 208, 29));

        jLabel10.setFont(new java.awt.Font("Microsoft JhengHei", 0, 14)); // NOI18N
        jLabel10.setText("Employee");
        add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(830, 420, 80, -1));
        ...
        if (!((userName.equals("") || (password.equals(""))))) {
            if (EcoSystem.checkIfUsernameIsUnique(userName)) {
                ...
                if (organization instanceof SupplierOrganization) {
                    Supplier s = system.getSupplierCatalog().addSupplier();
                    s.setSupplierName(employee.getName());
                    Supplier sup = ((SupplierOrganization) organization).getSupplierList().addSupplier();
                    sup.setSupplierName(employee.getName());
                }
